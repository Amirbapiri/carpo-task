...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://user:password@127.0.0.1:5432/monitoring'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'monitoring.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'monitoring.api.exception_handlers.hacksoft_proposed_exception_handler',
